    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl">
                <div className="bg-black/30 backdrop-blur-xl border border-white/10 rounded-full px-6 py-4 flex justify-between items-center shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                    ...
                    <nav className="hidden md:flex space-x-8">
                        {[
                            { name: "NEW", href: "/new" },
                            { name: "CLOTHING", href: "/clothing", active: true },
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-4">
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                            ...
                            <span className="block text-2xl md:text-3xl font-medium mt-2 text-white/70">
                                REDEFINE YOUR DIGITAL IDENTITY
                            </span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                        {[...Array(12)].map((_, index) => (
                            <Link href={`/products/item-${index + 1}`} key={index} className="group">
                                <div className="relative perspective-card">
                                    <div className="card-3d-effect bg-gradient-to-br from-black to-zinc-900 rounded-2xl p-1 transition-all duration-500 group-hover:shadow-[0_0_20px_rgba(255,0,255,0.2)]">
                                        <div className="aspect-[3/4] bg-zinc-900 rounded-xl overflow-hidden relative">
                                            <Image
                                                src={`/placeholder.svg?height=600&width=450&text=Item ${index + 1}`}
                                            ...
                                            {/* Product tag */}
                                            {index % 5 === 0 && (
                                                <div className="absolute top-3 left-3 bg-white text-black font-bold text-xs rounded-full px-3 py-1">
                                                    NEW
                                                </div>
                                            )}
                                            {index % 7 === 0 && (
                                    ...
                                    <div className="mt-3 px-1">
                                        <h3 className="text-sm font-medium truncate">
                                            Cyber Tech{" "}
                                            {index % 4 === 0 ? "Jacket" : index % 3 === 0 ? "Pants" : index % 2 === 0 ? "Hoodie" : "Tee"}
                                        </h3>
                                        <div className="flex justify-between items-center">
                                            <p className="text-white/70 text-sm">${(59 + index * 10).toFixed(2)}</p>
                                            <div className="flex gap-1">
                                                {[...Array(4)].map((_, i) => (
                                                    <div
                                                        key={i}
                                                        className={`w-1 h-1 rounded-full ${i < (4 - (index % 3)) ? "bg-fuchsia-500" : "bg-white/20"
                                                            }`}
                                                    ></div>
                                                ))}
                                            </div>
            ...
            <section className="py-16 relative">
                <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-950/30 to-black z-0"></div>
                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        <div className="space-y-6">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
                                CYBER <span className="text-fuchsia-500">CORE</span>
                            </h2>
                            <p className="text-lg text-white/70">
                                Futuristic designs with reflective materials and digital patterns. The perfect blend of technology and
                                fashion.
                            </p>
                        ...
                        <div className="relative h-[60vh] rounded-3xl overflow-hidden">
                            <Image
                                src="/placeholder.svg?height=800&width=600&text=CYBER CORE"
                                alt="Cyber Core Collection"
                                fill
